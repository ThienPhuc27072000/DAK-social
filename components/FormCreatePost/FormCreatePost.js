...
export default function FormCreatePost({ showModal, setShowModal }) {
  ...
  const [openFormChangePermission, setOpenFormChangePermission] =
    useState(false);
  const [listUsers, setListUsers] = useState([
    {
      id: 1,
      avt: "https://cdn.pixabay.com/photo/2012/06/08/06/19/clouds-49520_1280.jpg",
      name: "Nguyễn Thiên Phúc 1",
      active: false,
    },
    {
      id: 2,
      avt: "https://cdn.pixabay.com/photo/2012/06/08/06/19/clouds-49520_1280.jpg",
      name: "Nguyễn Thiên Phúc 2",
      active: false,
    },
    {
      id: 3,
      ...
      name: "Nguyễn Thiên Phúc 3",
      active: false,
    },
    {
      id: 4,
      avt: "https://cdn.pixabay.com/photo/2012/06/08/06/19/clouds-49520_1280.jpg",
      name: "Nguyễn Thiên Phúc 4",
      active: false,
    },
    {
      id: 5,
      avt: "https://cdn.pixabay.com/photo/2012/06/08/06/19/clouds-49520_1280.jpg",
      name: "Nguyễn Thiên Phúc 5",
      active: false,
    },
    {
      id: 6,
      avt: "https://cdn.pixabay.com/photo/2012/06/08/06/19/clouds-49520_1280.jpg",
      name: "Nguyễn Thiên Phúc 6",
      active: false,
    },
  ]);
                  ...
                  <div className={Styled.createPost}>
                    <div className={Styled.avtAndName}>
                      <img
                        ...
                        src={
                          "https://cdn.pixabay.com/photo/2012/06/08/06/19/clouds-49520_1280.jpg"
                        }
                      />
                      <h2 className={Styled.name}>Nguyễn Thiên Phúc</h2>
                      <div
                      ...
                      {openInputLink && (
                        <div className={Styled.boxInputLink}>
                          <input
                            ...
                            placeholder={"Dán link bài viết ở đây"}
                            value={linkPath}
                      ...
                      {listUsers.map((user) => (
                        <div className={Styled.user} key={user.id}>
                          ...
                          <h2
                            ...
                            onClick={(event) =>
                              handleAddUserTag(event, user.id, !user.active)
                            }
                          >
                            {user.name}
                          </h2>
                          <div
                            className={`${user.active && Styled.checkBox} 
                                                                    ${
                                                                      user.active &&
                                                                      Styled.checkBox2
                                                                    } 
