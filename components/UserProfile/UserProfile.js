                ...
                <div className={Styled.infoProfile}>
                    ...
                    <div className={Styled.textProfile}>
                        <div className={Styled.mainInfo}>
                            ...
                            <p className={Styled.captionUser}>Hi, mình là Phúc. Nice to meet you.  
                                Hi, mình là Phúc. Nice to meet you. Hi, mình là Phúc. Nice to meet you.
                            </p>
                            <div className={Styled.statisticInfo}
                                onClick={openStatistic}    
                            >
                                <p className={Styled.contentSatistic}> Vote  
                                    <span className={Styled.quantitySatistic}>2000</span>    
                                </p>
                                <p className={Styled.contentSatistic}> NFT 
                                    <span className={Styled.quantitySatistic}>1500</span>    
                                </p>
                                <p className={Styled.contentSatistic}> Following  
                                    <span className={Styled.quantitySatistic}>100</span>    
                                </p>
                                <p className={Styled.contentSatistic}> Follower 
                        ...
                        <ul className={Styled.profile__action}>
                            ...
                            <li className={Styled.profile__item} style={{backgroundColor: 'var(--main-color)'}}>
                                {/* <TiUserAdd className={Styled.profile__fixIcon} 
                                    style={{color: 'yellow'}}
                                />
                                <span className={Styled.profile__item_icon}>Follow</span> */}
                                <AiOutlinePlusCircle className={Styled.profile__fixIcon} style={{color: 'black'}}/>
                                <span className={Styled.profile__item_icon} style={{color: 'black'}}>Tạo tin</span> 
                            </li>                                
